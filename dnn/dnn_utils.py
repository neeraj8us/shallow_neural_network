...
def sigmoid_backward(dA, activation_cache):
    ...
    #print("Shape of sigmoid backwards " + str(ret.shape))
    return ret
...
def linear_activation_forward(A_prev, W, b, activation):
    ...
    if activation == "sigmoid":
        ...
        A, activation_cache = relu(Z)
        ### END CODE HERE ###
    #print(A.shape , (W.shape[0], A_prev.shape[1]))
...
def compute_cost(AL, Y):
    ...
    cost = (-1 / m) * np.sum(Y * np.log(AL + 0.00000001) + (1 - Y) * np.log(1.0000000001 - AL))
    ### END CODE HERE ###
...
def L_model_backward(AL, Y, caches):
    ...
    ### START CODE HERE ### (1 line of code)
    dAL = -(np.divide(Y, AL+0.0000001) - np.divide(1 - Y, 1.000001 - AL))
    ### END CODE HERE ###
